...
public class GameControllerTest {
	...
	private ICrossingController instance;

	@Before
	public void initForTests() {
		ICrossingStrategy level=new AtLeastOneCanSailStartegy();
		instance = new GameController(level); // EACH Team MUST PUT THEIR CONTROLLER
		instance.newGame(level); // to make sure it is fresh instance even if student used singleton 
	}
