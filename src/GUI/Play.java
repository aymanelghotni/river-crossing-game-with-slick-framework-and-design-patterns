...
public Play(int state) {
	...
	public void init(GameContainer gc, StateBasedGame sbg) throws SlickException{
		...
		newGame.execute();
		 BufferedImage[] farmerImages= game.getCrossersOnLeftBank().get(0).getImages();
		 BufferedImage[] wolfImages=game.getCrossersOnLeftBank().get(3).getImages();
		 BufferedImage[] sheepImages=game.getCrossersOnLeftBank().get(2).getImages();
		 BufferedImage[] cabbageImages=game.getCrossersOnLeftBank().get(1).getImages();
		...
		cabbage=movingRightCabbage;
		 farmerObj=game.getCrossersOnLeftBank().get(0);
		 cabbageObj=game.getCrossersOnLeftBank().get(1);
		 sheepObj=game.getCrossersOnLeftBank().get(2);
		 wolfObj=game.getCrossersOnLeftBank().get(3);
	...
	public void update(GameContainer gc, StateBasedGame sbg, int delta) throws SlickException{
		...
		if(flagWin==0)
		{
			...
			if(game.getCrossersOnRightBank().size()==4)
			{
				flagWin=1;
